    ...
    <div className="leadership-container">
      <div className="community-container">
        ...
        <p className="community-description">
          ...
          member who becomes an officer will remain on Management Council for
          the duration of service in that capacity. In appointing the members of
          the Management Council, an attempt shall be made to reflect the
          diversity of the campus.
        </p>
        <p className="community-description">
          Interested in joining AMP Management Council? Please email or contact
          one of the Management Council members below to learn more. Members
          also may nominate candidates and vote in the annual election of new
          members to the AMP Management Council. Nominations may be sent to{" "}
      ...
      <div className="contact-container">
        ...
        <p className="contact-description">
          We would love to hear from you! If you have any questions, feel free
